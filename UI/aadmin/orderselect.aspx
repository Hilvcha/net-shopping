    ...
    <div style =" text-align:center ;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="_order_num" HeaderText="订单号" />
                <asp:BoundField DataField="_pay_state" HeaderText="是否已付款" />
                <asp:BoundField DataField="_deliver_state" HeaderText="是否已发货" />
                <asp:TemplateField HeaderText="用户id">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("_id") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("_id") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="_order_time" HeaderText="订购时间" />
                <asp:TemplateField HeaderText="买家留言">
                    <ItemTemplate >
                    <%#Common.DB .substr (Eval ("_buy_remarks").ToString (),10 ) %>
                    
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="卖家留言">
                 <ItemTemplate >
                    <%#Common.DB .substr (Eval ("_sell_remarks").ToString (),10 ) %>
