...
<div style="text-align:center;">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:BoundField DataField="_user_id" HeaderText="会员号" />
            <asp:BoundField DataField="_user_name" HeaderText="会员昵称" />
            ...
            <asp:TemplateField HeaderText="删除" ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False"  OnClientClick="return confirm('您确定要删除这条记录吗？')"
                        CommandName="Delete" Text="删除" CommandArgument='<%#Eval("_user_id")%>'></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="查看详细信息">
            <ItemTemplate>
            <a href="usershow.aspx?id=<%#Eval("_user_id")%> ">查看详细信息</a>
            </ItemTemplate>
            </asp:TemplateField>
        </Columns>
