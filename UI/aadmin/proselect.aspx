...
<div>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="_product_name" HeaderText="标题">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_cateid" HeaderText="类别ID">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_post_time" HeaderText="上市时间">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_price_state" HeaderText="是否特价">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_special_offer" HeaderText="是否推荐">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_top" HeaderText="是否置顶">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="_product_count" HeaderText="库存">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
