     ...
     <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="_file_size" HeaderText="文件大小">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="_hiterate" HeaderText="点击率">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="_post_time" HeaderText="上传时间">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="_download_url" HeaderText="下载路径">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
