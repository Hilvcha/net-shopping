<%@ Page Language="C#" MasterPageFile="~/AccountCenter.master" AutoEventWireup="true" CodeFile="orderdetail.aspx.cs" Inherits="orderdetail" Title="无标题页" %>
...
<div>订单号：<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></div>
    <div style ="text-align : center ;">
        <asp:GridView ID="GridView1" runat="server" Width="100%" 
            ...
            <ItemTemplate>
              <a href ='ProInfo.aspx?uid=<%#Eval("_product_id") %> '>  <asp:Image ID="Image1" runat="server" ImageUrl ='<%#Eval("_product_image") %>' Height ="40px" Width ="40px"/></a>
            </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商品名称">
                   <ItemTemplate >
                   <a href ='ProInfo.aspx?uid=<%#Eval("_product_id") %> '><%#Eval ("_product_name") %></a>
                   </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="商品总价">
                   <ItemTemplate >
                       <asp:Label ID="sumprice" runat="server" Text='<%#Eval("_sum_price") %>'></asp:Label>
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商品总重">
                  <ItemTemplate >
                       <asp:Label ID="sumweight" runat="server" Text='<%#Eval("_sum_weight") %>'></asp:Label>
                   </ItemTemplate>
                </asp:TemplateField>
