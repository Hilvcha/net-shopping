...
namespace DAL
{
    public class DALadmin
    {
        public SqlDataReader checkAdmin(admin admim)
        {
            ...
            sql.Append("select * from admin where _admin_name=@name");
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from admin where _type=" + 0 + "");
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("update admin set _admin_name=@name,_password=@pwd where _id=@id");
        ...
        public SqlDataReader _login(admin admin)
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from admin where _admin_name=@name and _password=@pwd and _type=@role");
        ...
        {
            string sqlstr = "select * from admin where _type="+0+"";
        ...
        public int admin()
        {
            string sqlstr = "select count(*) from admin where _type="+0+"";
            int result;
        ...
        {
            string sqlstr = "select count(*) from admin where _admin_name like '%"+name+"%' and _type="+0+"";
            int result;
            if (Common.DB.ExecuteScalar(sqlstr) == null)
            {
                result = 0;
        ...
        public DataSet S_admin(int pageindex, int pagesize, string table,string name)
        {
            ...
            string sqlstr = "select * from admin where _admin_name like '%"+ name +"%' and _type="+0+"";
