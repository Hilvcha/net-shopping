...
namespace DAL
{
    public  class  user
    {
        ...
        public int insert(Model.user aa)
        {
            ...
            sql.Append("insert into [user] ( _user_name,_pwd,_email,_qq,_msn,_safe_question,_safe_pwd ) values(@username,@pwd,@email,@qq,@msn,@safeque,@safepwd)");
            SqlParameter[] par ={
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select _user_id from [user] where _email=@email");
            SqlParameter[] par ={
                                    new SqlParameter("@email",SqlDbType.VarChar,50)
                                };
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from [user] where  _user_id=@id");
            SqlParameter[] par ={
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("update [user] set _user_name=@username,_pwd=@pwd,_email=@email,_qq=@qq,_msn=@msn,_safe_question=@safeque,_safe_pwd=@safepwd  where _user_id=@id");
            SqlParameter[] par ={
                                    new  SqlParameter("@id",SqlDbType.Int,4),
                                    new  SqlParameter("@username",SqlDbType.VarChar,50),
                                    new  SqlParameter("@pwd",SqlDbType.VarChar,50),
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select  _user_id from [user] where _email=@email and _pwd=@pwd");
            SqlParameter[] par ={
                                    new SqlParameter("@email",SqlDbType.VarChar,50),
                                    new SqlParameter("@pwd",SqlDbType.VarChar,50)
                                };
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from [user] where _user_id=@userid");
            SqlParameter[] par ={
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("update [user] set _msn=@msn,_qq=@qq,_safe_question=@safe,_safe_pwd=@pwd where _user_id=@id");
            SqlParameter[] par ={
                                    new SqlParameter("@msn",SqlDbType.VarChar,50),
                                    new SqlParameter("@qq",SqlDbType.VarChar,50),
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from [user]  where _pwd=@pwd and _user_id=@id");
            SqlParameter[] par ={
                                    new SqlParameter("@pwd",SqlDbType.VarChar,50),
                                    new SqlParameter("@id",SqlDbType.Int,4)
                                };
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from collect where _user_id=@id");
            SqlParameter[] par ={
                                    new SqlParameter("@id",SqlDbType.Int ,4)
                                };
            par[0].Value = aa.userid;
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("update  [user] set _login_time=@time  where _user_id=@id");
            SqlParameter[] par = {
                                     new SqlParameter("@id",SqlDbType.Int,4),
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("update [user] set _pwd=@apwd  where _user_id=@id " );
            SqlParameter[] par ={
                                    new SqlParameter("@id",SqlDbType.Int,4),
    ...
    public class order
    {
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from ordertable where _user_id=@id  order by _order_time ");
            SqlParameter[] par ={
                                    new SqlParameter("@id",SqlDbType.Int,4)
                                };
            par[0].Value = aa.userid;
        ...
        {
            String sql = "select count(*)from ordertable where _user_id='" + aa.userid + "'";
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from ordertable where _order_num=@num");
            SqlParameter[] par = {
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from ordertable where _user_id=@id and _pay_ways=1 order by _order_time ");
            SqlParameter[] par = {
                                     new SqlParameter("@id",SqlDbType.Int,4)
                                 };
            par[0].Value = aa.userid;
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("delete from ordertable where _user_id=@uid and _id=@id");
            SqlParameter[] par = {
