...
namespace DAL
{
    public   class  collect
    {
        ...
        {
            String sql = "select count(*) from collect where _user_id='" + aa.userid + "'";
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("insert into collect (_user_id)values(@id)");
            SqlParameter[] par = {
                                     new SqlParameter("@id",SqlDbType .Int,4)
                                 };
            par[0].Value = aa.userid;
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("insert into collect (_user_id,_product_id,_product_name,_product_price,_product_image)values(@userid,@id,@name,@price,@image)");
            SqlParameter[] par = {
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("delete from collect where _collect_id=@id");
            SqlParameter[] par = {
                                     new SqlParameter("@id",SqlDbType.Int,4)
                                 };
            par[0].Value = aa.id;
        ...
        {
            StringBuilder sql = new StringBuilder();
            sql.Append("select * from collect where _product_id=@id");
            SqlParameter[] par = {
                                     new SqlParameter("@id",SqlDbType.Int,4)
                                 };
