   ...
   public class downlist
    {
       public  int  downloadadd(Model.downlist md)
       {
         ...
         sql.Append(" (_title,_file_size,_hiterate,_download_url)");
       ...
       public int update(Model.downlist md)
       {
           ...
           sql.Append(" _title=@name,_file_size=@size,_hiterate=@click,_download_url=@url  ");
