   ...
   public  class DALhelp
    {
       ...
       {
           StringBuilder sql = new StringBuilder();
           sql.Append("delete from help where _help_id=@id");
       ...
       {
           StringBuilder sql = new StringBuilder();
           sql.Append("update help set _user_question=@title,_answer=@content where _help_id=@id");
       ...
       {
           StringBuilder sql = new StringBuilder();
           sql.Append("select * from help where _help_id=@id");
       ...
       public DataSet _selectAll(int cateid)
       {
           ...
           StringBuilder sql = new StringBuilder();
           sql.Append("select top 3 * from help where _cateid="+cateid+" order by _help_id desc");
       ...
       public DataSet cj_ds(int cateid)
       {
           ...
           StringBuilder sql = new StringBuilder();
           sql.Append("select top 7 * from help where _cateid=" + cateid + " order by _help_id desc");
       ...
       {
           StringBuilder sql = new StringBuilder();
           sql.Append("select top 8 * from help where _cateid="+cateid+" order by _help_id desc");
