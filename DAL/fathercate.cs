   ...
   public  class fathercate
    {
       ...
       {
           string sql = "update fathercate set _top_layer_name='" + mym.fathername + "' where _top_layer_id=" + mym.fathercateid + "";
       ...
       {
           string sql = "delete from fathercate where _top_layer_id=" + f_id + " ";
           return Common.DB.ExecuteSql(sql);
       }
